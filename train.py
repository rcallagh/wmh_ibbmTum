...
def main():
    ...
    parser.add_argument('--es_metric', choices=['dice', 'jaccard', 'tversky', 'focal-tversky'], default='dice', help='Choice of early stopping monitoring metric (default: dice)')
    ...
    parser.add_argument('--loss', choices=['dice', 'jaccard', 'tversky', 'focal-tversky'], default='dice', help='Choice of loss function (default: dice)')
    parser.add_argument('--metrics', choices=['dice', 'jaccard', 'tversky', 'focal-tversky'], nargs='*', default=None, help='Choice of metric functions (default: None)')
